...
import LikeDisklikes from './Sections/LikeDisklikes';
      ...
      <Row gutter={[16, 16]}>
        <Col lg={18} xs={24}>
          <div style={{ width: '100%', padding: '3rem 4em' }}>
            ...
            <List.Item actions={[<LikeDisklikes video userId={localStorage.getItem('userId')} videoId={videoId} />, subscribeButton]}>
